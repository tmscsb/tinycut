  ...
  const shortcuts: { category: string; items: { keys: string[]; label: string }[] }[] = [
    {
      ...
      items: [
        ...
        { keys: ["Ctrl", "S"], label: "Save in this browser" },
        { keys: ["Ctrl", "O"], label: "Open a saved layout" },
        { keys: ["Ctrl", "N"], label: "New A4 document" },
        { keys: ["Ctrl", "]"], label: "Bring to front" },
        { keys: ["Ctrl", "["], label: "Send to back" },
        { keys: ["C"], label: "Crop the selected image" },
        { keys: ["X"], label: "Cut a piece from the selected image" },
        { keys: ["Esc"], label: "Deselect / exit crop or cut mode" },
        { keys: ["Enter"], label: "Apply crop, or cut a piece and keep cutting" },
